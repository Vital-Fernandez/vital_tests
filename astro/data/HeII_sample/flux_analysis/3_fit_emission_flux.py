    ...
    try:
        ...
        for lineLabel in linesForced:
            if lineLabel in lm.linesDF.index:
                ...
                properties_df.loc[obj, f'{lineLabel}'] = lm.linesDF.loc[lineLabel, 'gauss_flux']
                properties_df.loc[obj, f'{lineLabel}_err'] = lm.linesDF.loc[lineLabel, 'gauss_err']
    except:
        print('failure')
...
#                 lm.plot_line_mask_selection(local_maskDF[idcsObsLines], ncols=8)
#
#
#             # ------------------------------ Measure the fluxes
#             lm = sr.LineMesurer(wave, flux, redshift=z_i, normFlux=normFlux)
