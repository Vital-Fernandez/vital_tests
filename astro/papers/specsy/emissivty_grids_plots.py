import numpy as np
import pyneb as pn
from matplotlib import pyplot as plt, rcParams, cm, rc_context
...
def emisTeNe_2DPlot(coeffs, func_emis, te_ne_grid, emis_grid, line_label, output_address):
...
with rc_context(fig_cfg):
    emisTeNe_2DPlot(emiss_coeffs, emisEquation_HeI, (XX, YY), lineEmis, lineLabel, output_address=
                    '/home/vital/Desktop/emissivity_map.png')
