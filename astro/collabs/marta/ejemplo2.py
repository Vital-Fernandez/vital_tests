...
gp_spec.plot.bands(output_address=f'{line}.png')
...
gp_spec.save_frame('example1_Ha_linelog.txt')
gp_spec.save_frame('example1_Ha_linelog.pdf', param_list=['eqw', 'profile_flux', 'profile_flux_err'])
gp_spec.save_frame('example1_Ha_linelog.fits', page='9190-6102')
gp_spec.save_frame('example1_Ha_linelog.xlsx', page='9190-6102')
gp_spec.save_frame('example1_Ha_linelog.asdf', page='9190-6102')