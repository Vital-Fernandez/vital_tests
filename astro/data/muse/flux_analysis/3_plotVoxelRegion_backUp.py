...
from astro.data.muse.common_methods import compute_line_flux_image, lineAreas, image_array_binning, plot_voxel_flux
...
for i, obj in enumerate(objList):
    ...
    if i == 0:
        ...
        lineFlux_dict, levelFlux_dict, levelText_dict = compute_line_flux_image(lineAreas, wave_rest, cube, z_objs[i],
        ...
        image_label = {'xlabel': r'RA', 'ylabel': r'DEC', 'title': f'Galaxy {obj} {lineLabel}'}

        plot_voxel_flux(lineFlux_dict['H1_6563A'], voxel_coord, wave_rest, flux_voxel, image_fg=lineFlux_dict[lineLabel],
                     flux_levels=fluxLevels[2:], sky_wcs=wcs_cube)
