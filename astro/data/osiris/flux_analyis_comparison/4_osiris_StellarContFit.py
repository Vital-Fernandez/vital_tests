...
for i, obj in enumerate(objList):
    ...
    for ext in ('_BR', '_B'):
        ...
        print(obj, z_gp, mass_galaxy, massProcess_galaxy)

        # Plot the results
        sw.population_fraction_plots(fit_output, obj, 'Mass_fraction', massFracPlotFile)
        sw.population_fraction_plots(fit_output, obj, 'Light_fraction', LightFracPlotFile)
        sw.stellar_fit_comparison_plot(obj, Input_Wavelength, Input_Flux, Output_Flux, stellarPlotFile)
