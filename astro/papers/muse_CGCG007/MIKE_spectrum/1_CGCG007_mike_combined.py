...
ext_lines = {'blue': ['H1_4861A', 'H1_4340A', 'H1_4101A', 'H1_3734A', 'H1_3750A', 'H1_3770A', 'H1_3797A', 'H1_3703A'],
             'red':  ['H1_4861A', 'H1_6563A', 'H1_8545A', 'H1_8598A', 'H1_8665A', 'H1_8750A', 'H1_8862A', 'H1_9014A']}
...
for arm in list(arms_dict.keys()):
    for i_night in nights_range:
        ...
        redcorr_dict[arm][i_night] = compute_cHbeta(slice_df, reddening_curve=red_curve, R_v=R_v, ref_wave='H1_4861A',
                                                    compMode='gauss')
...
for arm in list(arms_dict.keys()):
    for i_night in nights_range:
        ...
        safe_cfg(cfg_file, param_dict, section_name='MIKE_extinction_summed_profiles')
