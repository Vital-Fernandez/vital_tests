...
class ListTools(ToolBase):
    """List all the pyPopstar controlled by the `ToolManager`."""
    # keyboard shortcut
    default_keymap = 'm'
...
# Add the custom pyPopstar that we created
...
#         # Don't do anything if the zoom/pan pyPopstar have been enabled.
#         return
#
