...
'''
    ...
    if (read_chains == True):
        ...
        i = 63 + self.keywords['N_base'] + 6 - 1 + N_par - 1 + 1 + 2 + self.keywords['N_base'] + 2 + self.keywords[
            'N_base'] + 2
    ...
    if (self.keywords['IsFIRcOn'] != 0):
        ...
        self.keywords['FIR_arq_ETCinfo'] = (data[_n3].split()[0]);
        _n3 += 1
        self.keywords['FIR_LumDistInMpc'] = float(data[_n3].split()[0]);
        _n3 += 1
        self.keywords['FIR_logLFIR_TOTInLsun'] = float(data[_n3].split()[0]);
        _n3 += 1
        self.keywords['FIR_LFIRFrac2Model'] = float(data[_n3].split()[0]);
        _n3 += 1
        self.keywords['FIR_logLFIR_obsInLsun'] = float(data[_n3].split()[0]);
        _n3 += 1
        self.keywords['FIR_ErrlogLFIRInDex'] = float(data[_n3].split()[0]);
        _n3 += 1
        self.keywords['FIR_RangelogLFIRInDex'] = float(data[_n3].split()[0]);
        _n3 += 1
        self.keywords['FIRChi2ScaleFactor'] = float(data[_n3].split()[0]);
        _n3 += 1
        self.keywords['FIR_logLFIR_lowInLsun'] = float(data[_n3].split()[0])
        self.keywords['FIR_logLFIR_uppInLsun'] = float(data[_n3].split()[1]);
        _n3 += 1
        self.keywords['FIRbeta_D'] = float(data[_n3].split()[0]);
        self.keywords['FIRbeta_I'] = float(data[_n3].split()[1]);
        _n3 += 1
        self.keywords['log_LFIR/LOpt_rough'] = float(data[_n3].split()[0]);
        _n3 += 1

        _n3 += 2

        self.keywords['FIRModlogLFIRInLsun'] = float(data[_n3].split()[0])
        self.keywords['FIRModObsRatio'] = float(data[_n3].split()[1]);
        _n3 += 1
        self.keywords['FIRModlogLBOLInLsun'] = float(data[_n3].split()[0])
        self.keywords['FIR_BOL_Ratio'] = float(data[_n3].split()[1]);
        _n3 += 1
        ...
        self.keywords['chi2_Opt/TOT_Perc'] = float(data[_n3].split()[1]);
        _n3 += 1
    ...
    if (self.keywords['IsQHRcOn'] != 0):
        ...
        self.keywords['QHRbeta_I'] = float(data[_n3].split()[0]);
        _n3 += 1
        self.keywords['QHR_arq_ETCinfo'] = (data[_n3].split()[0]);
        _n3 += 1
        self.keywords['QHR_LumDistInMpc'] = float(data[_n3].split()[0]);
        _n3 += 1
        self.keywords['QHR_GlobalChi2ScaleFactor'] = float(data[_n3].split()[0]);
        _n3 += 1
        self.keywords['NQHR_Ys'] = int(data[_n3].split()[0]);
        _n3 += 1
        ...
        self.keywords['ELR_errAV_neb'] = float(data[_n3].split()[7]);
        _n3 += 1
        ...
        if (self.keywords['IsELROn'] == 1):
            ...
            self.keywords['ELR_Chi2ScaleFactor'] = float(data[_n3].split()[4]);
            _n3 += 1
            ...
            self.keywords['ELR_chi2_ELR/chi2_TOT'] = float(data[_n3].split()[4]);
            _n3 += 1
        else:
            _n3 += 2
        ...
        self.keywords['log_QHeff_PhotPerSec'] = float(data[_n3].split()[1]);
        _n3 += 1
        ...
        self.keywords['chi2_Opt'] = float(data[_n3].split()[1])
        self.keywords['chi2_TOT'] = float(data[_n3].split()[2]);
        _n3 += 1
    ...
    if (self.keywords['IsPHOcOn'] != 0):
        ...
        self.keywords['PHO_arq_ETCinfo'] = (data[_n3].split()[0]);
        _n3 += 1
        self.keywords['PHO_LumDistInMpc'] = float(data[_n3].split()[0]);
        _n3 += 1
        self.keywords['PHO_Redshift'] = float(data[_n3].split()[0]);
        _n3 += 1
        self.keywords['PHO_GlobalChi2ScaleFactor'] = float(data[_n3].split()[0]);
        _n3 += 1
        self.keywords['NPHO_Ys'] = int(data[_n3].split()[0]);
        _n3 += 1
